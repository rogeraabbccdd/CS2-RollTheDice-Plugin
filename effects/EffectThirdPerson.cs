...
public class EffectThirdPerson : EffectBaseRegular, IEffectParameter
{
    ...
    public override string PrettyName { get; set; } = "Third Person".__("effect_name_thirdperson");
    public override string Description { get; set; } = "Third Person View".__("effect_description_thirdperson");
